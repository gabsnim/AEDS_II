...
class main
{
    ...
    public static void Q01 (LinkedList array, LinkedList lista, Scanner scan)
    {
        ...
        for(int i = 0; i <= n; i++)
        {
            ...
            else if(args[0].equals(("I*")))         //args terá 3 valores 
            {
                try 
                {
                    tmp = lista.getPos(Integer.parseInt(args[2]));
                    array.inserir(tmp, Integer.parseInt(args[1]));
                    // array.printList();
                    // scan.next();
                }
                catch (Exception e)
            ...
            else if(args[0].equals(("R*")))
            {
                try 
                {
                    array.remover(Integer.parseInt(args[1]));
                    // array.printList();
                    // scan.next();
                }
                catch (Exception e)
